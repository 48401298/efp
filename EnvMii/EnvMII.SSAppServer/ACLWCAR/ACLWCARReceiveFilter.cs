...
{
    /// <summary>
    /// ACTW-CAR小型清洁刷式温盐传感器消息过滤
    /// </summary>
    public class ACLWCARReceiveFilter : BeginEndMarkReceiveFilter<BinaryRequestInfo>
    {
        ...
        protected override BinaryRequestInfo ProcessMatchedRequest(byte[] readBuffer, int offset, int length)
        {
            ...
            return new BinaryRequestInfo("05", Tools.hexStrToByte(data.Substring(4, data.Length - 2 - 4)));
        }

...
namespace Manage.BLL.WH
{
    ...
    ///　编写日期：2017年07月02日
    /// </summary>
    public class WHInModeBLL:BaseBLL
    {
        #region 获取信息
        /// <summary>
        /// 获取信息
        ...
        public WHInMode Get(WHInMode model)
        {
            try
            {
                return new WHInModeDAL().Get(model);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<WHInMode> GetList()
        {
            return new WHInModeDAL().GetList(null);
        }
        ...
        public DataPage GetList(WHInMode condition, DataPage page)
        {
            try
            {
                return new WHInModeDAL().GetList(condition, page);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool ExistsWHInMode(WHInMode model)
        {
            try
            {
                return new WHInModeDAL().ExistsWHInMode(model);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataResult<int> Insert(WHInMode model)
        {
            ...
            try
            {
                ...
                if (ExistsWHInMode(model))
                {
                    result.Msg = "名称已存在";
                    result.Result = -1;
                    return result;
                }
                result.Result = new WHInModeDAL().Insert(model);
        ...
        public DataResult<int> Update(WHInMode model)
        {
            DataResult<int> result = new DataResult<int>();
            try
            {
                ...
                result.Result = new WHInModeDAL().Update(model);
                result.IsSuccess = true;
                return result;
            }
            catch (Exception ex)
        ...
        public DataResult<int> DeleteArray(string strs)
        {
            ...
            try
            {
                ...
                {
                    count += this.DeleteWHInMode(new WHInMode { ID = str });
                }
                result.Result = count;
                result.IsSuccess = true;
                return result;
        ...
        /// <param name="">信息</param>
        /// <returns>删除个数</returns>
        public int DeleteWHInMode(WHInMode model)
        {
            try
            {
                return new WHInModeDAL().Delete(model);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable GetExportData(WHInMode model)
        {
            try
            {
                return new WHInModeDAL().GetExportData(model);
            }
            catch (Exception ex)
            {
                throw ex;

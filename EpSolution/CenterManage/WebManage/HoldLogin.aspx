<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HoldLogin.aspx.cs" Inherits="Manage.Web.HoldLogin" %>
...
<body>
    ...
    <form id="form1" runat="server" class="form-signin">
        <h2 class="form-signin-heading">智慧渔业</h2>
            ...
            <div class="checkbox">
                <%--<label>
                    <input type="checkbox" value="记住用户名"> 记住用户名
                </label>--%>
            </div>

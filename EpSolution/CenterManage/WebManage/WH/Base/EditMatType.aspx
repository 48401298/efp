<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="EditMatType.aspx.cs" Inherits="Manage.Web.WH.Base.EditMatType" %>
...
<body class="easyui-layout">
    ...
    <div>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    <div class="easyui-panel" title="货品类别" style="padding:3px;">
                        <table>
                            <tr>
                                <td>
                                    <table class="editTable">
                                       <tr>
                                        ...
                                        <tr>
                                           ...
                                           <asp:TextBox ID="Remark" CssClass="easyui-validatebox" MaxLength="25" runat="server"></asp:TextBox>
                                           </td>
                                        </tr>                 
                                    </table>
                                </td>

<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ManageWHSpec.aspx.cs" Inherits="Manage.Web.WH.Base.ManageWHSpec" %>
...
<body class="easyui-layout">
    ...
    <script language=javascript type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWHSpec.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWHSpec.aspx?id=" + id, '500', '460');
            return false;
        }

<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ListStockLimit.aspx.cs" Inherits="Manage.Web.WH.Base.ListStockLimit" %>
...
<body class="easyui-layout">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MinAmount" HeaderText="库存线下" />
                                            <asp:BoundField DataField="WarehouseName" HeaderText="所属仓库">
                                            <HeaderStyle Width="150px" />
                                            </asp:BoundField>
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditStockLimit.aspx?whID=" + $("#hiWHID").val(), '460', '320');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditStockLimit.aspx?id=" + id, '460', '320');
            return false;
        }

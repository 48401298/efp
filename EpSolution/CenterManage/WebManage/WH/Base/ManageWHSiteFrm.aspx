<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ManageWHSiteFrm.aspx.cs" Inherits="Manage.Web.WH.Base.ManageWHSiteFrm" %>
...
<body class="easyui-layout">
    <form id="form1" runat="server">  
		...
		<div data-options="region:'center',title:'仓位'">
            <div class="easyui-layout" data-options="border:false" fit="true" style="width:100%; height:100px;overflow:hidden;">
                 <iframe id="frmList" width="100%" height="100%" frameborder=0 src="ListWHSite.aspx"></iframe>
            </div>
        </div>  
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectWH(whID) {
            document.getElementById("frmList").src = "ListWHSite.aspx?whID=" + whID;
        }
    </script>
</body>
</html>

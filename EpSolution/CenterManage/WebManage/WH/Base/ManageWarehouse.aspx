<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ManageWarehouse.aspx.cs" Inherits="Manage.Web.WH.Base.ManageWarehouse" %>
...
<body class="easyui-layout">
    <form id="form1" runat="server">    
        ...
        <div data-options="region:'center',border:false" style="padding-right: 10px; padding-left: 10px;">
            <div  class="easyui-layout" data-options="border:false" fit="true" style="width:100%; height:600px;overflow:hidden;">		
                  ...
                  <div data-options="region:'center'" title="仓库列表">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Code" HeaderText="仓库编号">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Description" HeaderText="仓库名称">
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWarehouse.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWarehouse.aspx?id=" + id, '500', '460');
            return false;
        }

<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ManageWHClient.aspx.cs" Inherits="Manage.Web.WH.Base.ManageWHClient" %>
...
<body class="easyui-layout">
    <form id="form1" runat="server">    
        ...
        <div data-options="region:'center',border:false" style="padding-right: 10px; padding-left: 10px;">
            <div  class="easyui-layout" data-options="border:false" fit="true" style="width:100%; height:600px;overflow:hidden;">		
                  ...
                  <div data-options="region:'center'" title="收货单位列表">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ClientName" HeaderText="供应商">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AreaCode" HeaderText="所在地区">
                                            </asp:BoundField>
    ...
    <script language=javascript type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWHClient.aspx", '500', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWHClient.aspx?id=" + id, '500', '460');
            return false;
        }

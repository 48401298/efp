<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ListWHSite.aspx.cs" Inherits="Manage.Web.WH.Base.ListWHSite" %>
    ...
    <form id="form1" runat="server">    
        ...
        <div data-options="region:'center',border:false" style="padding-right: 10px; padding-left: 10px;">
            <div  class="easyui-layout" data-options="border:false" fit="true" style="width:100%; height:600px;overflow:hidden;">		
                    ...
                    <div class="easyui-panel" title="查询条件" style="height:68px;padding:3px;">
                        ...
                        <tr>
                            <td align="right">
                                仓位编号</td>
                            <td>
                                <asp:TextBox ID="Code" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>  
                            <td align="right">
                                仓位名称</td>
                            <td>
                  ...
                  <div data-options="region:'center'" title="仓位列表">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Code" HeaderText="仓位编号">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Description" HeaderText="仓位名称">
                                            <HeaderStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AreaName" HeaderText="所属区域" />
                                            <asp:BoundField DataField="WarehourseName" HeaderText="所属仓库">
                                            <HeaderStyle Width="150px" />
                                            </asp:BoundField>
        ...
        <asp:HiddenField ID="hiWHID" runat="server" />
    </form>
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWHSite.aspx?whID=" + $("#hiWHID").val(), '460', '300');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWHSite.aspx?id=" + id, '460', '300');
            return false;
        }

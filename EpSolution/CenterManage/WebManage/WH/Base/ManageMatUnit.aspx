<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ManageMatUnit.aspx.cs" Inherits="Manage.Web.WH.Base.ManageMatUnit" %>
...
<body class="easyui-layout">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Description" HeaderText="计量单位">
    ...
    <script language=javascript type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditMatUnit.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditMatUnit.aspx?id=" + id, '500', '460');
            return false;
        }

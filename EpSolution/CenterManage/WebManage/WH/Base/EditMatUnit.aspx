<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="EditMatUnit.aspx.cs" Inherits="Manage.Web.WH.Base.EditMatUnit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>编辑计量单位信息</title>
...
<body class="easyui-layout">
    ...
    <div>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    <div class="easyui-panel" title="计量单位信息" style="padding:3px;">
                        <table>
                            <tr>
                                <td>

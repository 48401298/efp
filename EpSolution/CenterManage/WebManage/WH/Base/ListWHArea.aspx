<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ListWHArea.aspx.cs" Inherits="Manage.Web.WH.Base.ListWHArea" %>
...
<body class="easyui-layout">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Code" HeaderText="区域编号">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Description" HeaderText="区域名称">
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWHArea.aspx?whID=" + $("#hiWHID").val(), '460', '300');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWHArea.aspx?id=" + id, '460', '300');
            return false;
        }

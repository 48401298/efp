<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ManageWHProvider.aspx.cs" Inherits="Manage.Web.WH.Base.ManageWHProvider" %>
...
<body class="easyui-layout">
    <form id="form1" runat="server">    
        ...
        <div data-options="region:'center',border:false" style="padding-right: 10px; padding-left: 10px;">
            <div  class="easyui-layout" data-options="border:false" fit="true" style="width:100%; height:600px;overflow:hidden;">		
                  ...
                  <div data-options="region:'center'" title="供货单位列表">
    ...
    <script language=javascript type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWHProvider.aspx", '500', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWHProvider.aspx?id=" + id, '500', '460');
            return false;
        }

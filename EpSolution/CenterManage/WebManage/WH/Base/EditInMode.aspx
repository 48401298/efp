<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="EditInMode.aspx.cs" Inherits="Manage.Web.WH.Base.EditInMode" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>编辑入库方式信息</title>
...
<body class="easyui-layout">
    ...
    <div>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    <div class="easyui-panel" title="入库方式信息" style="padding:3px;">
                        <table>
                            <tr>
                                <td>
                                    <table class="editTable">
                                       <tr>
                                        <th align=left>入库方式</th><td>

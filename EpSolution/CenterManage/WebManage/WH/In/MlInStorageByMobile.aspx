<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="MlInStorageByMobile.aspx.cs" Inherits="Manage.Web.WH.In.MlInStorageByMobile" %>
...
<body class="easyui-layout">
    ...
    <div>
        <table style="width:100%;">            
            <tr>
                <td>
                    <div class="easyui-panel" title="入库（条码）" style="width:98%; overflow: hidden;">
                                        ...
                                        <th nowrap="nowrap">数量</th>
                                            <td nowrap="nowrap">
                                                <table cellpadding=0 cellspacing=0 
                                                    ...
                                                    <tr>
                                                        <td><asp:TextBox ID="InAmount" runat="server" ReadOnly="True" class="easyui-validatebox" Width="100%" ></asp:TextBox></td>
                                       ...
                                       <tr>
                                        <th nowrap="nowrap">核算数量</th>
                                            <td nowrap="nowrap" style="width:100%">
                                                <table cellpadding=0 cellspacing=0 style="border-style: none; border-width: 0px;width:100%">
                                                    <tr>
                                                        <td style="width:50%"><asp:TextBox ID="MainUnitAmount" runat="server" class="easyui-validatebox" ReadOnly="True"
                                        ...
                                        <th nowrap="nowrap">仓库</th>
                                            <td>
                                                <table cellpadding=0 cellspacing=0>
                                                    ...
                                                    <th nowrap="nowrap">仓位</th><td><asp:DropDownList ID="SaveSite" runat="server">
                                       ...
                                       <tr>
                                            ...
                                            <td>
                                                <table cellpadding=0 cellspacing=0>
                                                    <tr>
                                                        ...
                                                        <td><asp:TextBox ID="ProduceDate" runat="server" Width="100px"></asp:TextBox></td>
                                                    </tr>
                                                </table>                                                
                                             </td>                                        
                                        </tr>
                                        ...
                                        <td align=left colspan="2">
                                            <table id="tblmat" style="height:100px;width:100%" iconCls="icon-edit">
                                                <thead>
			                                        <tr>                                   
				                                        <th field="MatBarCode" align="center" width="150">货品条码</th>
    ...
    <asp:HiddenField ID="HiUnit" runat="server" />
     ...
     <script language="javascript" type="text/javascript">
         ...
         function addMat() {
             ...
             mat["ProduceDate"] = $("#ProduceDate").val();

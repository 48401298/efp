<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="QueryStockAmount.aspx.cs" Inherits="Manage.Web.WH.Query.QueryStockAmount" %>
                    ...
                    <div class="easyui-panel" title="查询条件" style="height:58px;padding:3px;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="CbxDetail" runat="server" Checked="True" Text="显示明细" />
                            </td>                            
                            <td>
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="核算数量" DataField="MainAmount">
                                            </asp:BoundField>
                                             <asp:BoundField DataField="MainUnitName" HeaderText="主计量单位" />                                            

<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ViewInMatList.aspx.cs" Inherits="Manage.Web.WH.Query.ViewInMatList" %>
...
<body class="easyui-layout">
    <form id="form1" runat="server">    
        ...
        <div data-options="region:'center',border:false" style="padding-right: 10px; padding-left: 10px;">
            <div data-options="region:'center'" title="入库查询明细">

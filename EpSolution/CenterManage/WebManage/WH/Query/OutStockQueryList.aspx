<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="OutStockQueryList.aspx.cs" Inherits="Manage.Web.WH.Query.OutStockQueryList" %>
...
<body class="easyui-layout">
    ...
    <script language=javascript type="text/javascript">
        ...
        function view(WarehouseID, MatID, StartDate, EndDate) {
            openAppWindow1('出库明细查询', "ViewOutMatList.aspx?WarehouseID=" + WarehouseID + "&MatID=" + MatID

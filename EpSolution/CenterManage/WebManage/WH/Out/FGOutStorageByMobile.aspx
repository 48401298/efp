<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="FGOutStorageByMobile.aspx.cs" Inherits="Manage.Web.WH.Out.FGOutStorageByMobile" %>

<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产成品出库移动端</title>
...
<body class="easyui-layout">
    ...
    <div>
        <table style="width:100%;">            
            <tr>
                <td>
                    <div class="easyui-panel" title="产成品出库" style="width:98%;overflow: hidden;">
                        <table cellpadding=0 cellspacing=0 width=100%>
                            <tr>
                                <td>
                                    <table width=100%>
                                       <tr>
                                        <th align=left nowrap="nowrap">产品条码</th><td>
                                       ...
                                       <tr>
                                        <th align=left>数量</th>
                                            <td>
                                                <table cellpadding=0 cellspacing=0 style="border-style: none; border-width: 0px;width:100%">
                                                    <tr>
                                                        <td><asp:TextBox ID="OutAmount" runat="server" class="easyui-validatebox" Width="100%"></asp:TextBox></td>
                                       ...
                                       <tr>
                                        ...
                                        <td align=left colspan="2">
                                            <table id="tblmat" style="height:100px;width:100%" iconCls="icon-edit">
                                                <thead>
			                                        <tr>                                   
				                                        <th field="IDCode" align="center" width="150">产品条码</th>

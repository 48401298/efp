<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="OutMatStorageMobile.aspx.cs" Inherits="Manage.Web.WH.Out.OutMatStorageMobile" %>
...
<body class="easyui-layout">
    ...
    <div>
        <table style="width:100%;">            
            <tr>
                <td>
                    <div class="easyui-panel" title="出库(数量)" style="width:98%;overflow: hidden;">
                                       ...
                                       <tr>
                                        <th align=left>数量</th>
                                            <td style="width:100%">
                                                <table cellpadding=0 cellspacing=0 style="border-style: none; border-width: 0px;width:100%">
                                                    <tr>
                                                        <td style="width:50%"><asp:TextBox ID="MainUnitAmount" runat="server" class="easyui-numberbox" 

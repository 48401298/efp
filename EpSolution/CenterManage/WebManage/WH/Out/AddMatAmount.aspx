<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="AddMatAmount.aspx.cs" Inherits="Manage.Web.WH.Out.AddMatAmount" %>
...
<body class="easyui-layout">
    ...
    <div>
        <div class="easyui-panel" title="出库信息" style="width:98%">
               ...
               <tr>
                                            <th>数量</th><td>
                                             ...
                                             <table cellpadding=0 cellspacing=0 width=100%>
                                                <tr><td align=left>
                                               <asp:TextBox ID="OutAmount" runat="server" class="easyui-validatebox" Width="100%" 
                                                    ></asp:TextBox>

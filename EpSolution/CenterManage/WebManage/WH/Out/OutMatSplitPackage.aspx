<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="OutMatSplitPackage.aspx.cs" Inherits="Manage.Web.WH.Out.OutMatSplitPackage" %>

<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>出库（按条码拆包）</title>
...
<body class="easyui-layout">
    ...
    <div>
        <table style="width:100%;">            
            <tr>
                <td>
                    <div class="easyui-panel" title="出库(按条码拆包)" style="width:98%;overflow: hidden;">
                                       ...
                                       <tr>
                                        <th align=left>数量</th>
                                            <td style="width:100%">
                                                <table cellpadding=0 cellspacing=0 style="border-style: none; border-width: 0px;width:100%">
                                                    <tr>
                                                        <td style="width:50%"><asp:TextBox ID="OutAmount" runat="server" class="easyui-validatebox" ReadOnly="True" Width="100%"></asp:TextBox></td>
                                                        <td style="width:50%"><asp:TextBox ID="UnitCode" runat="server" ReadOnly="True" Width="100%"></asp:TextBox></td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table id="tblmat" style="height:100px;width:100%" iconCls="icon-edit">
                                                <thead>
			                                        <tr>                                   
                                                        ...
                                                        <th field="UnitName" align="center" width="60">单位</th>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageRole.aspx.cs" Inherits="Manage.Web.Role.ManageRole" %>
...
<body class="easyui-layout">
                    ...
                    <div class="easyui-panel" title="查询条件" style="height:68px;padding:3px;">
                        ...
                        <tr>
                            <td align="right">
                                角色名称</td>
                            <td>
                                <asp:TextBox ID="RoleName" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>                            
                        </tr>                            
                        </table>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        onrowupdating="GvList_RowUpdating" DataKeyNames="RoleID">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="RoleDESC" HeaderText="角色">
    ...
    <script language=javascript type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditRole.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditRole.aspx?id=" + id, '500', '460');
            return false;
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppDefault.aspx.cs" Inherits="Manage.Web.AppDefault" %>
        ...
        <div class="main-container" id="main-container">
            ...
            <div id="sidebar" class="sidebar                  responsive">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="">
                        <a href="#" onclick="GotoUrl('MobileApp/InspectDataQuery.aspx');return false;" class="dropdown-toggle">
                    ...
                    <li class="">
                        <a href="#" onclick="GotoUrl('MobileApp/GoodsTraceQuery.aspx');return false;" class="dropdown-toggle">
            ...
            <div class="main-content">
                ...
                <div class="page-content" style="text-align:center">
                    <div class="row">
                        <div class="row">
                            <button class="btn btn-app btn-primary" onclick="GotoUrl('MobileApp/InspectDataQuery.aspx');return false;" style="height:150px;width:90%">环境监测</button>                                                                            
                        </div>
                        <div class="row">
                            <button class="btn btn-app btn-primary" onclick="GotoUrl('MobileApp/GoodsTraceQuery.aspx');return false;" style="height:150px;width:90%">质量追溯</button> 
                        </div>
                    </div>

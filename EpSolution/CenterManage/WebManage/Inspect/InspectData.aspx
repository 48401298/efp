<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="InspectData.aspx.cs" Inherits="Manage.Web.Inspect.InspectData" %>
                        ...
                        <table class="condiTable">
                            <tr>
                                <td>
                                    所在机构</td>
                                <td>
                                    <asp:DropDownList ID="OrganID" runat="server" onchange="organIdChange(this);return false;">
                                    </asp:DropDownList>
                                </td>
                                ...
                                <td>
                                    设备类型</td>
                                <td>
                                    <asp:DropDownList ID="DeviceType" runat="server" onchange="deviceTypeChange(this);return false;"></asp:DropDownList>
                                </td>
                                <td>
                                    监测设备</td>
                                <td>

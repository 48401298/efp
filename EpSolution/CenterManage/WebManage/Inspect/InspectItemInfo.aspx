<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectItemInfo.aspx.cs" Inherits="Manage.Web.Inspect.InspectItemInfo" %>
...
<body class="easyui-layout">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ItemCode" HeaderText="项目编号"></asp:BoundField>
                                            <asp:BoundField DataField="ItemName" HeaderText="项目名称" />
                                            <asp:BoundField DataField="Unit" HeaderText="单位" />
                                            <asp:BoundField DataField="PointCount" HeaderText="小数位数" />
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditInspectItemInfo.aspx", '500', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditInspectItemInfo.aspx?id=" + id, '500', '460');
            return false;
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectResult.aspx.cs" Inherits="Manage.Web.Inspect.InspectResult" %>
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ResultType" HeaderText="结果类型" />

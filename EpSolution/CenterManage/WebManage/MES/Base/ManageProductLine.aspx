<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageProductLine.aspx.cs" Inherits="Manage.Web.MES.Base.ManageProductLine" %>
...
<body class="easyui-layout">
                ...
                <div class="easyui-panel" title="查询条件" style="height: 68px; padding: 3px;">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="PLCODE" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>
                            <td align="right">
                                生产线名称
                            </td>
                            <td>
                                <asp:TextBox ID="PLNAME" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
            </div>
            <div data-options="region:'center'" title="生产线信息列表">
                        ...
                        <td>
                            <asp:GridView ID="GvList" Width=100% runat="server" AutoGenerateColumns="False" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PLCODE" HeaderText="生产线编号">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PLNAME" HeaderText="生产线名称">
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditProductLine.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditProductLine.aspx?id=" + id, '500', '460');
            return false;
        }

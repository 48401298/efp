<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageWorkStation.aspx.cs" Inherits="Manage.Web.MES.Base.ManageWorkStation" %>
...
<body class="easyui-layout">
                ...
                <div class="easyui-panel" title="查询条件" style="height: 68px; padding: 3px;">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="WSCODE" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>
                            <td align="right">
                                工位名称
                            </td>
                            <td>
                                <asp:TextBox ID="WSNAME" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
            </div>
            <div data-options="region:'center'" title="工位信息">
                        ...
                        <td>
                            <asp:GridView ID="GvList" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="WSCODE" HeaderText="工位编号">
                                        <HeaderStyle />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="WSNAME" HeaderText="工位名称">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="FNAME" HeaderText="所属工厂">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PLNAME" HeaderText="所属工序">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ENAME" HeaderText="相关设备">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditWorkStation.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditWorkStation.aspx?id=" + id, '500', '460');
            return false;
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageProcessFlow.aspx.cs" Inherits="Manage.Web.MES.Base.ManageProcessFlow" %>
...
<body class="easyui-layout">
    ...
    <div data-options="region:'center',border:false" style="padding-right: 10px; padding-left: 10px;">
        <div class="easyui-layout" data-options="border:false" fit="true" style="width: 100%;
            ...
            <div data-options="region:'center'" title="工艺流程列表">
                        ...
                        <td>
                            <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PCODE" HeaderText="流程编号">
                                        <HeaderStyle Width="150px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PNAME" HeaderText="流程名称">
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditProcessFlow.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditProcessFlow.aspx?id=" + id, '500', '460');
            return false;
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanManagementList.aspx.cs" Inherits="Manage.Web.MES.PlanManagement.PlanManagementList" %>
...
<body class="easyui-layout">
    ...
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditPlanManagement.aspx", '460', '450');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditPlanManagement.aspx?id=" + id, '500', '460');
            return false;
        }

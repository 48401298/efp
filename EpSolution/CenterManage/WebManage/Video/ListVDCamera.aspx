<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListVDCamera.aspx.cs" Inherits="Manage.Web.Video.ListVDCamera" %>
...
<body class="easyui-layout">
    <form id="form1" runat="server">    
                    ...
                    <div class="easyui-panel" title="查询条件" style="height:68px;padding:3px;">
                        ...
                        <tr>
                            <td align="right">
                                摄像头编号</td>
                            <td>
                                <asp:TextBox ID="CameraCode" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>  
                            <td align="right">
                                摄像头名称</td>
                            <td>
                                <asp:TextBox ID="CameraName" runat="server" CssClass="easyui-textbox"></asp:TextBox>
                            </td>                          
                        </tr>                            
                        </table>
                    </div>
                  </div>        
                  <div data-options="region:'center'" title="摄像头列表">
                                ...
                                <td>
                                    <asp:GridView ID="GvList" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CameraCode" HeaderText="摄像头编号">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="CameraName" HeaderText="摄像头名称">
                                            <HeaderStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="EquKind" HeaderText="设备类型">
                                            <HeaderStyle Width="150px" />
                                            </asp:BoundField>
        ...
        <asp:HiddenField ID="hiPostionID" runat="server" />
    </form>
    <script language="javascript" type="text/javascript">
        //增加
        function add() {
            openAppWindow1('增加', "EditVDCamera.aspx?postionID=" + $("#hiPostionID").val(), '500', '420');
            return false;
        }
        //编辑
        function edit(id) {
            openAppWindow1('编辑', "EditVDCamera.aspx?id=" + id, '500', '420');
            return false;
        }
